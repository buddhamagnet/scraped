...
var HTMLvalid string
var HTMLinvalid string

func init() {
	HTMLvalid = `<!DOCTYPE html>
...
`
	...
	HTMLinvalid = "<html></html>"
}

func TestScrape(t *testing.T) {
	bot, _ := scraper.NewBot(strings.NewReader(HTMLvalid))
	bot.Process()
...
func TestScrapeInvalid(t *testing.T) {
	bot, _ := scraper.NewBot(strings.NewReader(HTMLinvalid))
	bot.Process()
